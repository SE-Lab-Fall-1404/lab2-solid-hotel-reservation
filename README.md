...
- **عضو ۱:** حامد صبور - قابلیت ارسال پیامک (SMS)
- **عضو ۲:** آریان انصاری - قابلیت پرداخت حضورى (On-Site Payment)

---

## تاریخچه تغییرات

- **تاریخ:** ۸/۹/۱۴۰۴ - افزودن قابلیت ارسال پیامک
- **تاریخ:** ۸/۹/۱۴۰۴ - افزودن قابلیت پرداخت حضورى
- **تاریخ:** ۸/۹/۱۴۰۴ - تحلیل اصول SOLID
- **تاریخ:** ۸/۹/۱۴۰۴ - اصلاح موارد نقض و رعایت اصول SOLID
